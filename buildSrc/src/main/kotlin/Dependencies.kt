object Dependencies {
  ...
  val jettyAlpnJava = "org.eclipse.jetty:jetty-alpn-java-server:10.0.7"
  val jettyBom = "org.eclipse.jetty:jetty-bom:10.0.7"
  val jettyHttp2 = "org.eclipse.jetty.http2:http2-server:10.0.7"
  val jettyServer = "org.eclipse.jetty:jetty-server:10.0.7"
  val jettyServlet = "org.eclipse.jetty:jetty-servlet:10.0.7"
  val jettyServlets = "org.eclipse.jetty:jetty-servlets:10.0.7"
  val jettyUnixSocket = "org.eclipse.jetty:jetty-unixsocket-server:10.0.7"
  val jettyWebsocketServer = "org.eclipse.jetty.websocket:websocket-jetty-server:10.0.7"
  val jettyWebsocketServlet = "org.eclipse.jetty.websocket:websocket-servlet:10.0.7"
